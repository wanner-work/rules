...
export default function Navbar() {
  return (
    <div className="w-full absolute z-10">
      <div className="max-w-2xl mx-auto w-full mt-8 relative px-8 lg:px-0">
        <div className="rounded-xl backdrop-blur-2xl p-3 flex justify-between">
          <div className="flex gap-6 items-center">
            ...
            >
              ...
              <g fill="none">
                <path
                  ...
                  fill="url(#1752500502802-4771403_ruler-pen_existing_0_aut75e2kp)"
                  data-glass="origin"
                  mask="url(#1752500502802-4771403_ruler-pen_mask_alrdoff0r)"
                ></path>
                <path
                  d="M17.5715 18.9907L15.4578 21.1044C16.1167 21.7634 16.4462 22.0929 16.8138 22.2451C17.3038 22.4481 17.8544 22.4481 18.3445 22.2451C18.712 22.0929 19.0415 21.7634 19.7004 21.1044L20.9656 19.8392C21.7577 19.0472 22.1537 18.6512 22.3021 18.1945C22.4326 17.7928 22.4326 17.3602 22.3021 16.9585C22.1537 16.5018 21.7577 16.1058 20.9656 15.3138L8.68617 3.03429C7.89414 2.24226 7.49812 1.84624 7.04147 1.69786C6.63978 1.56735 6.20709 1.56735 5.8054 1.69786C5.34874 1.84624 4.95273 2.24226 4.16069 3.03429L2.88793 4.30705C2.23399 4.96099 1.90702 5.28796 1.75489 5.65182C1.54754 6.14773 1.54854 6.70624 1.75766 7.20141C1.91109 7.56471 2.23923 7.89051 2.89551 8.54211L5.00924 6.42838C5.39976 6.03786 6.03293 6.03786 6.42345 6.42838C6.81398 6.81891 6.81398 7.45207 6.42345 7.8426L4.30213 9.96392L14.036 19.6978L16.1573 17.5765C16.5478 17.186 17.181 17.186 17.5715 17.5765C17.9621 17.967 17.9621 18.6002 17.5715 18.9907Z"
                  fill="url(#1752500502802-4771403_ruler-pen_existing_0_aut75e2kp)"
                  data-glass="clone"
                  filter="url(#1752500502802-4771403_ruler-pen_filter_2dcgk6oxb)"
                  clipPath="url(#1752500502802-4771403_ruler-pen_clipPath_eehexvvp0)"
                ></path>
                <path
                  ...
                  fill="url(#1752500502802-4771403_ruler-pen_existing_1_5id9ssfzo)"
                  data-glass="blur"
                ></path>
                <path
                  ...
                  fill="url(#1752500502802-4771403_ruler-pen_existing_2_8pb1frn03)"
                ></path>
                <defs>
                  <linearGradient
                    id="1752500502802-4771403_ruler-pen_existing_0_aut75e2kp"
                    x1="12"
                    y1="1.6"
                    x2="12"
                    y2="22.397"
                  ...
                  <linearGradient
                    id="1752500502802-4771403_ruler-pen_existing_1_5id9ssfzo"
                    x1="12.079"
                    y1="2.071"
                    x2="12.079"
                    y2="21.77"
                  ...
                  <linearGradient
                    id="1752500502802-4771403_ruler-pen_existing_2_8pb1frn03"
                    x1="12.079"
                    y1="2.072"
                    x2="12.079"
                    y2="13.479"
                  ...
                  <filter
                    id="1752500502802-4771403_ruler-pen_filter_2dcgk6oxb"
                    x="-100%"
                    y="-100%"
                    width="400%"
                    height="400%"
            ...
            <p className="text-[#e1e1e1] text-xs flex gap-2 items-center">
          ...
          <div>
            <Link
              href="/docs"
              className="inline-flex items-center gap-2 rounded-lg bg-white px-4 py-1.5 text-sm font-medium text-black transition-colors hover:bg-white/80"
            >
              Docs
            </Link>
          </div>
